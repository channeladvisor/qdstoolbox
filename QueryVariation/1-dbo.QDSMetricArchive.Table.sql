----------------------------------------------------------------------------------
-- Table Name: [dbo].[QDSMetricArchive]
--
-- Desc: This table is used by the procedure [dbo].[QueryVariation] to store components of the dynamic queries
--			so the commands can be build depending on the entry parameters
--		This script populates the table as well
--
-- Columns:
...
--			Component of the dynamic T-SQL command generated for the specific [Measurement] / [Metric] pair
--
